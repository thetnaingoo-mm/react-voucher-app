...
const VoucherTableRow = ({
    index, 
    record: { id, cost, quantity, product: { product_name, price } }
    }) => {
    ...
    return (
        <tr className="group odd:bg-white even:bg-gray-50  border-b ">
            ...
            <th
                scope="row"
                className="record-name text-end px-6 py-4 font-medium text-gray-900 whitespace-nowrap"
            >
                {product_name}
            </th>
            ...
            <td className="px-6 py-4 text-end">
                ...
                <span className="record-q w-5 inline-block me-2">{quantity}</span>
                <button
